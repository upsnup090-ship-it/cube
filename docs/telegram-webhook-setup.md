...
- `/help` — подробная справка по правилам игры.
- `/play <ставка> [кубики]` — создать PvP-игру. Пример: `/play 100` или `/play 100 2`.
- `/join <код>` — вступить в игру по коду. Пример: `/join G1ABC2DE`.
- `/balance` — показать доступный и заблокированный баланс кошелька.
- `/cancel` — отменить свою ожидающую игру (только до вступления противника).

Для броска — отправить стандартный Telegram dice 🎲 в чат.
